...
typedef struct {
    ...
    uint8 sas01TestValue01;/* StartBit:0, Length:8, unsigned, Intel */
    uint16 sas01TestValue02;/* StartBit:22, Length:12, unsigned, Intel */
    uint16 sas01TestValue03;/* StartBit:62, Length:12, unsigned, Motorola */
}ST_Sas01;
...
typedef struct{
    ...
    uint8 aliveCount;/* StartBit:0, Length:8, unsigned, Intel */
    uint16 echoSas01TestValue02;/* StartBit:22, Length:12, unsigned, Intel */
    uint16 echoSas01TestValue03;/* StartBit:62, Length:12, unsigned, Motorola */
}ST_Sdc01;
...
static void processingDataTx(void) {
    stSdc01.echoSas01TestValue02 = stSas01.sas01TestValue02 + 1u;
    stSdc01.echoSas01TestValue03 = stSas01.sas01TestValue03 + 1u;
