...
*/
#define ADC_KERNELS_PER_SYNGRP             (2U)
...
#define ADC_MAX_KERNELS    (2U)
/* ADC Kernels Configured to use */
#define ADC_USED_KERNELS   (0x0003U)
...
#define ADC_KERNELS_PER_CLUSTER  (1U)
...
*/
#define ADC_KERNEL_USED_COUNT  (2U)
...
*/
#define ADC_QM_KERNEL_USED_COUNT  (2U) 
...
#define ADC_KERNEL_REQSRC0_USED  (0x0002U)
#define ADC_KERNEL_REQSRC1_USED  (0x0001U)
...
/* Configuration: ADC_MAX_CH_CON_TIME_COUNT (Vendor specific)
  ...
  No. of conversion time count = tSYS (2+(4+0+8)1) / tSYS + 
                               ...
                               = 14 + 2 = 16
*/
#define ADC_MAX_CH_CON_TIME_COUNT                 (100U)
...
#ifndef AdcConf_AdcChannel_HwVersionResistance /* to prevent double declaration */
#define AdcConf_AdcChannel_HwVersionResistance  ((Adc_ChannelType)0)
#endif /* AdcConf_AdcChannel_HwVersionResistance */
/* ADC1 HW Unit */

#ifndef AdcConf_AdcChannel_IgnitionVoltage /* to prevent double declaration */
#define AdcConf_AdcChannel_IgnitionVoltage  ((Adc_ChannelType)0)
#endif /* AdcConf_AdcChannel_IgnitionVoltage */

#ifndef AdcConf_AdcChannel_BatteryVoltage /* to prevent double declaration */
#define AdcConf_AdcChannel_BatteryVoltage  ((Adc_ChannelType)1)
#endif /* AdcConf_AdcChannel_BatteryVoltage */
...
/* AdcHwUnit_0 */
 ...
 #ifndef AdcConf_AdcGroup_AdcHwUnit0_AdcGroup0 /* to prevent double declaration */
 #define AdcConf_AdcGroup_AdcHwUnit0_AdcGroup0   ((Adc_GroupType)0)
 #endif /* AdcConf_AdcGroup_AdcHwUnit0_AdcGroup0 */


/* AdcHwUnit_1 */

 #ifndef AdcConf_AdcGroup_AdcHwUnit1_AdcGroup0 /* to prevent double declaration */
 #define AdcConf_AdcGroup_AdcHwUnit1_AdcGroup0   ((Adc_GroupType)32)
 #endif /* AdcConf_AdcGroup_AdcHwUnit1_AdcGroup0 */
