...
*******************************************************************************/
...
#ifdef Can_17_MCanPConf_CanHardwareObject_SAC_01 /* to prevent double declaration */
  #if (Can_17_MCanPConf_CanHardwareObject_SAC_01 != 3U)
    #error Can_17_MCanPConf_CanHardwareObject_SAC_01 is already defined with a different value
  #endif  
#else
  /*IFX_MISRA_RULE_01_04_STATUS=The generated macro may exceed 31 characters 
  to follow Autosar naming conventions*/
  /*IFX_MISRA_RULE_05_01_STATUS=The generated macro may exceed 31 characters
  to follow Autosar naming conventions*/
  #define Can_17_MCanPConf_CanHardwareObject_SAC_01   (3U) 
#endif /* #ifdef Can_17_MCanPConf_CanHardwareObject_SAC_01 */
