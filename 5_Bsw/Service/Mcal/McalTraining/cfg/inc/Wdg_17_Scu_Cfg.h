...
#define WDG_17_SCU_SW_MINOR_VERSION   (4U)
...
*/
#define WDG_INITIAL_TIMEOUT       ((uint16)5000U)

/* WDG_MAX_TIMERS : holds maximum number of WDG timers  */
#define WDG_MAX_TIMERS            (1U) 
