...
/*IFX_MISRA_RULE_08_08_STATUS=Gpt_kConfigPtr is declared extern only here and
 is defined in Gpt.c. This violation is reported incorrectly by PC-lint tool*/
...
/*IFX_MISRA_RULE_08_08_STATUS=Gpt_DriverMode is declared extern only here and
 is defined in Gpt.c. This violation is reported incorrectly by PC-lint tool*/
extern volatile uint8 Gpt_DriverMode;

/*IFX_MISRA_RULE_08_08_STATUS=Gpt_ChannelIndex is declared extern only here and
 is defined in Gpt.c. This violation is reported incorrectly by PC-lint tool*/
...
/*IFX_MISRA_RULE_08_08_STATUS=Gpt_ChannelIdentifier is declared extern
 only here and is defined in Gpt.c. This violation is reported
...
#include "MemMap.h"
/*IFX_MISRA_RULE_08_08_STATUS=Gpt_AsilChannelStatus is declared extern
 only here and is defined in Gpt.c. This violation is reported incorrectly
 by PC-lint tool*/
...
#define GPT_START_SEC_VAR_8BIT
#include "MemMap.h"
/*IFX_MISRA_RULE_08_08_STATUS=Gpt_QMChannelStatus is declared extern
 only here and is defined in Gpt.c. This violation is reported incorrectly
 by PC-lint tool*/
...
#define GPT_START_SEC_ASIL0_VAR_8BIT
#include "MemMap.h"
/*IFX_MISRA_RULE_08_08_STATUS=Gpt_AsilFlag is declared extern only here and
 is defined in Gpt.c. This violation is reported incorrectly by PC-lint tool*/
...
#define GPT_START_SEC_VAR_8BIT
#include "MemMap.h"
/*IFX_MISRA_RULE_08_08_STATUS=Gpt_QMFlag is declared extern only here and
 is defined in Gpt.c. This violation is reported incorrectly by PC-lint tool*/
...
*******************************************************************************/
                                  ...
                                  (GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) )
/*******************************************************************************
** Syntax           : _IFXEXTERN_ IFX_INLINE uint8 *Gpt_lGetDataAddress       **
**                    (                                                       **
**                       Gpt_ChannelType Channel                              **
**                    )                                                       **
** Traceability     : [cover parentID=DS_MCAL_GPT_503,
DS_MCAL_GPT_506]                                                              **
**                                                                            **
** Service ID       : NA                                                      **
**                                                                            **
...
**                                                                            **
*******************************************************************************/
_IFXEXTERN_ IFX_INLINE uint8 *Gpt_lGetDataAddress(Gpt_ChannelType Channel)
...
/*******************************************************************************
** Syntax           : _IFXEXTERN_ IFX_INLINE uint8 *Gpt_lGetStatusVarAddr     **
**                    (                                                       **
**                       Gpt_ChannelType Channel                              **
**                    )                                                       **
** Traceability     : [cover parentID=DS_MCAL_GPT_503,
...
**                                                                            **
*******************************************************************************/
_IFXEXTERN_ IFX_INLINE uint8 *Gpt_lGetStatusVarAddr(Gpt_ChannelType Channel)
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for inline functions defined
  in header files*/
{
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for inline functions defined
...
flag value */
_IFXEXTERN_ IFX_INLINE uint8 Gpt_lGetWakeupNotifFlag(Gpt_ChannelType Channel)
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for inline functions defined
  in header files*/
{
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for inline functions defined
...
_IFXEXTERN_ IFX_INLINE boolean Gpt_lCheckForSetWakeupEvent(uint8 WakeupFlag)
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for inline functions defined
  in header files*/
{
...
_IFXEXTERN_ IFX_INLINE boolean Gpt_lModeCont(Gpt_ModeType ChannelMode)
/*IFX_MISRA_RULE_08_05_STATUS=Allowed for inline functions defined
  in header files*/
{
