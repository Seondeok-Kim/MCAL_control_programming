...
// Del #include "Test_Print.h"
/* Inclusion of Irq.h */
#include "Irq.h"

#if (IFX_MCAL_USED == STD_ON)
// Del #include "DemoApp_Cfg.h"
#endif
...
typedef struct 
{
  uint32 data1;       /* User Code Start Address                             */
  uint32 data2;   /* Inverted Check Result for the Memory Range          */
  uint32 data3;       /* Check Result for the ABM Header (offset 00H..17H)   */
  uint32 data4;    /* Inverted Check Result for the ABM Header            */
}APP_HDR;
...
// Del extern __indirect void Test_InitTime(void);
// Del extern void DemoApp_CallMenuFctCpu1 (void);
// Del extern void DemoApp_CallMenuFctCpu2 (void);
...
#if 0
#pragma protect on
#pragma section farrom "BMD_HDR_CONST_FAR_UNSPECIFIED_0"
...
#pragma protect on
#pragma section farrom "APP_HDR_CONST_FAR_UNSPECIFIED_0"

const APP_HDR appl_header =
{
 0x0100AA11,
 0x072AC023,
 0x41410808,
...
// Del void Mcal_Core1Functionality(void);
// Del void Mcal_Core2Functionality(void);
...
/* 
   ...
   The mathematical function name is �뛾�룄�뿠iling(r)占쎈쐻�뜝占�?
...
void Mcal_EcuMInit()
{
  ...
  EcuMConfigPtr =  &EcuM_ConfigAlternative[CfgSelector];
   ...
   // Del Test_InitTime(); /* Initialize Time Measurement For Run Time Calc */
   // Del Test_InitPrint();/* Initialize ASC0 for Hyperterminal Communication*/
  #endif
