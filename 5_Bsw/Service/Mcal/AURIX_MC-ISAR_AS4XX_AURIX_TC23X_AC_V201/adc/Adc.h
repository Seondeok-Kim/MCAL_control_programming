...
/*
  ...
  TC1797 supports following reference voltage high 
...
/*
  ...
  TC2Dx supports following resolutions
  ADC_CH_RES_8BIT 
  ADC_CH_RES_10BIT
  ADC_CH_RES_12BIT
*/
...
/*
  ...
  Adc driver supports following status
  ADC_IDLE
  ADC_BUSY
  ADC_COMPLETED
...
/*
  ...
  Adc driver supports following trigger source
  ADC_TRIGG_SRC_SW
  ADC_TRIGG_SRC_HW
*/
...
/*
   ...
   Adc driver supports the following conversion mode
...
/*
  ...
  ADC driver supports the following buffer types
...
/*
  ...
  ADC driver supports the following result access mode
...
/*
  ...
  ADC driver supports the following trigger edges
