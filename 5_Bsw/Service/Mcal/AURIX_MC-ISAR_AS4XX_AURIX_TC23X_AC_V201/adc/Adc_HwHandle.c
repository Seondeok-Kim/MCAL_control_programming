...
/* RS3 internal trigger */
#define ADC_RS3_INTERNAL_TRIG        (0x0F00U)
/* Bit postion of ITSEL bitfield */
#define ADC_ITSEL_BIT_POS            (24U)
/* Bit postion of TSCSET bitfield */
#define ADC_TSCSET_BIT_POS           (16U)
/* Clear the TRCTR register */
#define ADC_CLEAR_TRCTR_REG          (0x80000000U)
...
#if (ADC_REQSRC3 == ADC_REQSRC_USED)
IFX_LOCAL_INLINE void Adc_lStartHwConvQueue3RS
(
  const Adc_GroupCfgType* GrpPtr,
  uint8                   AdcKernel
);
#endif /* (ADC_REQSRC3 == ADC_REQSRC_USED) */
...
IFX_LOCAL_INLINE void Adc_lStartSwConvQueue3RS
(
  const Adc_GroupCfgType* GrpPtr,
  uint8                   AdcKernel
);
...
/*******************************************************************************
** Traceabilty      :[cover parentID=DS_MCAL_ADC_0402_1,DS_NAS_EP_ADC_PR0402,
                     DS_MCAL_ADC_9002_1]
...
void Adc_IsrSrn0AdcRS0(uint8 AdcKernel)
{
  ...
  #endif /* (ADC_REQSRC0 == ADC_REQSRC_USED) */

  #if (ADC1_REQSRC3 == ADC_REQSRC_USED)
  /* Handles the interrupt of ADC Kernel 1 Request source 3 */
  if ( AdcKernel == ADC_HWUNIT_ADC1 )
  {
    if ( (Adc_lReadSrcEvntFlagSfr(AdcKernel,ADC_REQSRC3_EVENT_OCCURED)) \
                                               == ADC_REQSRC3_EVENT_OCCURED )
    {
      Adc_lIsr(AdcKernel, ADC_REQSRC3_8STG_QUE);
    }
    #if (ADC_SAFETY_ENABLE == STD_ON)
    else
    {
  ...
  #endif /* (ADC1_REQSRC3 == ADC_REQSRC_USED)*/
...
/*******************************************************************************
** Traceabilty      :[cover parentID=DS_MCAL_ADC_0402_2,DS_MCAL_ADC_9002_2]
...
/*******************************************************************************
** Traceabilty      :[cover parentID=DS_MCAL_EP_ADC_9002_4]
...
/*******************************************************************************
** Traceabilty      :[cover parentID=DS_NAS_EP_ADC_PR0402,DS_MCAL_EP_ADC_9002_6]
** Syntax           : void Adc_IsrSrn1CG0AdcRS3(uint8 AdcKernel)              **
**                                                                            **
** Service ID       : none                                                    **
**                                                                            **
** Sync/Async       : Synchronous                                             **
...
**                                                                            **
*******************************************************************************/
void Adc_IsrSrn1CG0AdcRS3(uint8 AdcKernel)
{
     ...
     )
  {
    ...
    */
    ...
    if( (GrpRequestSrc == ADC_REQSRC0_8STG_QUE) ||
                            (GrpRequestSrc == ADC_REQSRC3_8STG_QUE) )
    {
...
)
{
  ...
  if(AdcKernel == 0U)
  {
    ...
    CompareValue &= (ReadValue ^ (~(uint32)(ADC_RS0_RS1_ADC0RS3_NODEPOINTER)));
  }
  else
  {
    /* Checking SEVNP register */
    ...
    ReadValue = (uint32)(
                 ADC_SFR_INIT_USER_MODE_READ32(ADC_MODULE[AdcKernel].SEVNP.U));
    CompareValue &= (ReadValue ^ (~(uint32)(ADC_RS0_RS1_ADC1RS3_NODEPOINTER)));
  }
...
IFX_LOCAL_INLINE Std_ReturnType Adc_lSetSreCheck(void)
{
  ...
  /* Checking ADC Common Group 0 SRN1 register */
  ReadValue = (uint32)(((uint32)ADC_SFR_INIT_USER_MODE_READ32(  \
                                MODULE_SRC.VADC.CG[0].SR1.U)) & \
                        ((uint32)IFX_SRC_SRCR_SRE_MSK << IFX_SRC_SRCR_SRE_OFF));
  ReadValue =  (uint32)(ReadValue >> IFX_SRC_SRCR_SRE_OFF);
  CompareValue &= (ReadValue ^ (~(uint32)(1)));

  #endif /* (ADC0_REQSRC3 is used) */

  #if (ADC1_REQSRC3 == ADC_REQSRC_USED)

  /* Checking ADC1 SRN0 register */
  ReadValue = (uint32)(((uint32)ADC_SFR_INIT_USER_MODE_READ32(  \
                                MODULE_SRC.VADC.G[1].SR0.U)) & \
                        ((uint32)IFX_SRC_SRCR_SRE_MSK << IFX_SRC_SRCR_SRE_OFF));
  ReadValue =  (uint32)(ReadValue >> IFX_SRC_SRCR_SRE_OFF);
  CompareValue &= (ReadValue ^ (~(uint32)(1)));

  #endif /* (ADC1_REQSRC3 is used) */
...
)
{
  ...
  #if( ADC_SAME_CHANNEL_QUEUING == STD_ON )
  if( (GroupRs == ADC_REQSRC0_8STG_QUE) || (GroupRs == ADC_REQSRC3_8STG_QUE) )
  {
...
)
{
  uint32                    ReadVfFlag;
                                        ...
                                        (ADC_REQSRC3 == ADC_REQSRC_USED))
  uint32                    ReadValue;
  #endif/* REQSRC0 or REQSRC1 or REQSRC3 used */
  #if( ((ADC_REQSRC0 == ADC_REQSRC_USED) || (ADC_REQSRC3 == ADC_REQSRC_USED))\
  ...
  switch (GrpReqSrc)
  {
    ...
    #if (ADC_REQSRC3 == ADC_REQSRC_USED)
    /* ADC SCAN request source RS1 */
    case ADC_REQSRC3_8STG_QUE:
    {
      /* Stop the sequence by closing the gate */
      /* The next and all Queue entry are cleared */
      /*IFX_MISRA_RULE_17_04_STATUS=Array indexing is used to efficiently
      access the SFRs of multiple ADC kernels*/
      ADC_SFR_RUNTIME_USER_MODE_WRITE32(ADC_MODULE[AdcKernel].QMR3.U,  \
      ...
      access the SFRs of multiple ADC kernels*/
      ADC_SFR_RUNTIME_USER_MODE_WRITE32(
                              ADC_MODULE[AdcKernel].QCTRL3.U, ADC_REQSRC_RESET);
      ...
      */
      ...
      ADC_SFR_RUNTIME_USER_MODE_WRITE32(ADC_MODULE[AdcKernel].CEFCLR.U,  \
                                                     (uint32)GrpPtr->IntChMask);
      /* Clear the Internal triggering of RS3 */
      /*IFX_MISRA_RULE_17_04_STATUS=Array indexing is used to efficiently
      access the SFRs of multiple ADC kernels*/
      ADC_SFR_RUNTIME_USER_MODE_WRITE32(ADC_MODULE[AdcKernel].TRCTR.U,  \
                                                   (uint32)ADC_CLEAR_TRCTR_REG);
    ...
    break; /* QUEUE3 request source  */
    #endif /* RS3 used by any of the ADC kernel */
...
)
{
  ...
  switch (GrpReqSrc)
  {
    ...
    #if (ADC_REQSRC3 == ADC_REQSRC_USED)
    /* QUEUE3 request source */
    case ADC_REQSRC3_8STG_QUE:
    {
      Adc_lStartSwConvQueue3RS(GrpPtr,AdcKernel);
    }
    break; /* Queue Request source */
    #endif /* RS3 used by any of the ADC kernel */
...
#if (ADC_REQSRC3 == ADC_REQSRC_USED)
/*******************************************************************************
** Syntax           : IFX_LOCAL_INLINE void Adc_lStartSwConvQueue3RS          **
**                    (                                                       **
**                       const Adc_GroupCfgType* GrpPtr,                      **
**                       uint8 AdcKernel                                      **
**                    )                                                       **
...
)
{
  ...
  ReadValue = (uint32)Adc_lClearEventFlag(GrpPtr->GrpRequestSrc);
  /* New conversion is starting in Request source ,
     any pending source interrupt is cleared
  */
  /*IFX_MISRA_RULE_17_04_STATUS=Array indexing is used to efficiently
  access the SFRs of multiple ADC kernels*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(ADC_MODULE[AdcKernel].SEFCLR.U, ReadValue);
  /* Clear the Result register event flag */
  /*IFX_MISRA_RULE_17_04_STATUS=Array indexing is used to efficiently
  access the SFRs of multiple ADC kernels*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(ADC_MODULE[AdcKernel].REFCLR.U, \
  ...
  access the SFRs of multiple ADC kernels*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(
                           ADC_MODULE[AdcKernel].QMR3.U, ADC_QUEUE_MODE_CLEAR);
  ...
  */
  ...
  while (LoopCount < TotalGrpCh)
  {
    ...
    /*IFX_MISRA_RULE_17_04_STATUS=Array indexing is used to efficiently
    access the SFRs of multiple ADC kernels*/
    ADC_SFR_RUNTIME_USER_MODE_WRITE32(ADC_MODULE[AdcKernel].QINR3.U,  \
                                            ((uint32)IntChNr | ConversionMode));
  ...
  access the SFRs of multiple ADC kernels*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(
                               ADC_MODULE[AdcKernel].QMR3.U, ADC_QUEUE_SW_TRIG);

} /* Adc_lStartSwConvQueue3RS */
#endif /* (ADC_REQSRC3 == ADC_REQSRC_USED) */
...
)
{
  ...
  switch (GrpReqSrc)
  {
    ...
    case ADC_REQSRC3_8STG_QUE:
    {
      Adc_lStartHwConvQueue3RS(GrpPtr,AdcKernel);
    }
    break; /* Queue request source */
    #endif /* RS3 used by any of the ADC kernel */
...
#if (ADC_REQSRC3 == ADC_REQSRC_USED)
/*******************************************************************************
** Syntax           : IFX_LOCAL_INLINE void Adc_lStartHwConvQueue3RS          **
**                    (                                                       **
**                       const Adc_GroupCfgType* GrpPtr,                      **
**                       uint8 AdcKernel                                      **
**                    )                                                       **
...
** Return value     : None                                                    **
**                                                                            **
** Description      : Is called when HW trigger type Group has to be started  **
*******************************************************************************/
IFX_LOCAL_INLINE void Adc_lStartHwConvQueue3RS
(
  const Adc_GroupCfgType* GrpPtr,
...
)
{
  ...
  ReadValue = Adc_lClearEventFlag(GrpPtr->GrpRequestSrc);
  /* New conversion is starting in Request source,
     any pending source interrupt is cleared
  */
  /*IFX_MISRA_RULE_17_04_STATUS=Array indexing is used to efficiently
  ...
  /* Internal triggering of RS3 */
  if(TriggSel == ADC_RS3_INTERNAL_TRIG)
  {
    /*IFX_MISRA_RULE_17_04_STATUS=Array indexing is used to efficiently
    access the SFRs of multiple ADC kernels*/
    ADC_SFR_RUNTIME_USER_MODE_WRITE32(ADC_MODULE[AdcKernel].TRCTR.U,  \
                    ( (GrpPtr->Rs3IntTrigger << (uint32)ADC_ITSEL_BIT_POS) | \
                      (GrpPtr->TrigSeqCount << (uint32)ADC_TSCSET_BIT_POS ) \
                    ));
  }
  ...
  /*IFX_MISRA_RULE_17_04_STATUS=Array indexing is used to efficiently
  access the SFRs of multiple ADC kernels*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(ADC_MODULE[AdcKernel].QCTRL3.U,  \
          ( (uint32)ADC_WRITE_TIM_GAT_TRG_MODE_ENABLE | (TriggSel) | \
                           (TriggMode) | (GateSel) | (TimerEnable) ));
...
void Adc_lGtmTimerCfg(const Adc_GroupCfgType* GrpPtr)
{
  ...
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
                                   TOM_CH[ModuleNum].CH[ChannelNum].CN0.U), 0U);
  /* Set the Compare register CM0 of TOM */
  /*IFX_MISRA_RULE_11_05_STATUS=volatile typecasting is removed, since it
  gives compile time warning in windriver compiler*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
                            TOM_CH[ModuleNum].CH[ChannelNum].CM0.U), ReloadVal);
  /* Set the Compare register CM1 of TOM */
  /*IFX_MISRA_RULE_11_05_STATUS=volatile typecasting is removed, since it
  gives compile time warning in windriver compiler*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
      TOM_CH[ModuleNum].CH[ChannelNum].CM1.U), (ReloadVal/ADC_TIMER_VALUE_DIV));

  /* Set the Shadow register SR0 of TOM */
  /*IFX_MISRA_RULE_11_05_STATUS=volatile typecasting is removed, since it
  gives compile time warning in windriver compiler*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
                            TOM_CH[ModuleNum].CH[ChannelNum].SR0.U), ReloadVal);

  /* Set the Shadow register SR1 of TOM */
  /*IFX_MISRA_RULE_11_05_STATUS=volatile typecasting is removed, since it
  gives compile time warning in windriver compiler*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
      TOM_CH[ModuleNum].CH[ChannelNum].SR1.U), (ReloadVal/ADC_TIMER_VALUE_DIV));
  ...
  if(ChannelNum < ADC_GTM_TOM_TGC0_CHOSEN)
  {
   /*IFX_MISRA_RULE_11_05_STATUS=volatile typecasting is removed, since it
    gives compile time warning in windriver compiler*/
   ADC_SFR_RUNTIME_USER_MODE_WRITE32((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
                    TOM_TGC[ModuleNum].TGC[ADC_GTM_TGC0].ENDIS_STAT.U,\
  ...
  else
  {
   /*IFX_MISRA_RULE_11_05_STATUS=volatile typecasting is removed, since it
    gives compile time warning in windriver compiler*/
   ADC_SFR_RUNTIME_USER_MODE_WRITE32((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
                    TOM_TGC[ModuleNum].TGC[ADC_GTM_TGC1].ENDIS_STAT.U,\
...
void Adc_lStopGtmTimer(const Adc_GroupCfgType* GrpPtr)
{
  ...
  gives compile time warning in windriver compiler*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
                                   TOM_CH[ModuleNum].CH[ChannelNum].CM0.U), 0U);
  /* Reset the Compare register CM1 of TOM */
  /*IFX_MISRA_RULE_11_05_STATUS=volatile typecasting is removed, since it
  gives compile time warning in windriver compiler*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
                                   TOM_CH[ModuleNum].CH[ChannelNum].CM1.U), 0U);

  /* Reset the Shadow register SR0 of TOM */
  /*IFX_MISRA_RULE_11_05_STATUS=volatile typecasting is removed, since it
  gives compile time warning in windriver compiler*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
                                   TOM_CH[ModuleNum].CH[ChannelNum].SR0.U), 0U);

  /* Reset the Shadow register SR1 of TOM */
  /*IFX_MISRA_RULE_11_05_STATUS=volatile typecasting is removed, since it
  gives compile time warning in windriver compiler*/
  ADC_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_TOMx*)(void*)(MODULE_GTM.TOM)).\
                                   TOM_CH[ModuleNum].CH[ChannelNum].SR1.U), 0U);
...
)
{
  ...
  if ( AdcKernel == 0U )
  {
    Adc_lWriteSrcEvntNpSfr(AdcKernel, ADC_RS0_RS1_ADC0RS3_NODEPOINTER);
  }
  else
  {
    Adc_lWriteSrcEvntNpSfr(AdcKernel, ADC_RS0_RS1_ADC1RS3_NODEPOINTER);
  }
...
void Adc_lInitSetResetSre(uint32 AdcSreValue)
{
  ...
  /* Common Group 0 SRN1 is used by request source 3 of ADC0 */
  #if (ADC0_REQSRC3 == ADC_REQSRC_USED)

  ADC_SFR_INIT_MODIFY32(MODULE_SRC.VADC.CG[0].SR1.U,  \
                ADC_SRC_SRCR_MSK, ((uint32)AdcSreValue << IFX_SRC_SRCR_SRE_OFF))

  #endif /* (ADC0_REQSRC3 is used) */

  /* ADC1 SRN0 is is used by request source 3 of ADC1
     Shared with request source 0 */
  #if (ADC1_REQSRC3 == ADC_REQSRC_USED)

  ADC_SFR_INIT_MODIFY32(MODULE_SRC.VADC.G[1].SR0.U,  \
                ADC_SRC_SRCR_MSK, ((uint32)AdcSreValue << IFX_SRC_SRCR_SRE_OFF))
...
void Adc_lDeInitSetResetSre(uint32 AdcSreValue)
{
  ...
  ADC_SFR_DEINIT_MODIFY32(MODULE_SRC.VADC.CG[0].SR1.U,  \
                ADC_SRC_SRCR_MSK, ((uint32)AdcSreValue << IFX_SRC_SRCR_SRE_OFF))
  ...
  ADC_SFR_DEINIT_MODIFY32(MODULE_SRC.VADC.G[1].SR0.U,  \
                ADC_SRC_SRCR_MSK, ((uint32)AdcSreValue << IFX_SRC_SRCR_SRE_OFF))
