...
**                                                                            **
**  $CC VERSION : \main\dev_tc23x\dev_patch_rel330\1 $                       **
**                                                                            **
**  $DATE       : 2017-05-13 $                                               **
**                                                                            **
...
#define MCU_CCUCON0_MASK_CLOCK_DIVIDERS      ((uint32)0x033F0FF8U)
#define MCU_CCUCON1_MASK_CLOCK_DIVIDERS      ((uint32)0x0FFFFFFFU)
#define MCU_CCUCON2_MASK_CLOCK_DIVIDERS      ((uint32)0x0000000FU)
#define MCU_CCUCON5_MASK_CLOCK_DIVIDERS      ((uint32)0x0000004FU)
...
#define MCU_CCUCON0_UP_SETMASK1               0x40000008U
...
Std_ReturnType Mcu_lPlatformInit(void)
{
                                          ...
                                          != (uint32)MCU_BITVAL_0)
 {
   ...
   MCU_SFR_INIT_MODIFY32(SCU_CCUCON0.U,MCU_CCUCON0_UP_CLEARMASK,8U)
                                          ...
                                          != (uint32)MCU_BITVAL_0)
   {
     ...
     MCU_SFR_INIT_WRITE32(SCU_CCUCON0.U,(unsigned_int)\
                    ((Mcu_kConfigPtr->ClockCfgPtr[Mcu_ClockSetting].Ccucon0) &\
                                           MCU_CCUCON0_MASK_CLOCK_DIVIDERS)|8U);
   }
  MCU_SFR_INIT_SETSAFETYENDINIT_TIMED();
...
void Mcu_lSetIdleMode(uint8 CoreId)
{
  ...
  /* Write PMCSR0.REQSLP */
    ...
    MCU_SFR_RUNTIME_MODIFY32(SCU_PMCSR0.U,~(((uint32)(~(MCU_IDLE+1U)) & \
                (uint32)IFX_SCU_PMCSR_REQSLP_MSK)<<IFX_SCU_PMCSR_REQSLP_OFF),\
  ((uint32)(MCU_IDLE+1U) & IFX_SCU_PMCSR_REQSLP_MSK)<<IFX_SCU_PMCSR_REQSLP_OFF)
...
void Mcu_lSetSleepMode(uint8 CoreId)
{
  ...
  /* Write PMCSR0.REQSLP */
     ...
     MCU_SFR_RUNTIME_RESETENDINIT();
    #endif
  MCU_SFR_RUNTIME_MODIFY32(SCU_PMCSR0.U,~(((uint32)(~(MCU_SLEEP+1U)) & \
                (uint32)IFX_SCU_PMCSR_REQSLP_MSK)<<IFX_SCU_PMCSR_REQSLP_OFF),\
  ((uint32)(MCU_SLEEP+1U) & IFX_SCU_PMCSR_REQSLP_MSK)<<IFX_SCU_PMCSR_REQSLP_OFF)
...
void Mcu_lSetStandbyMode(uint8 CoreId)
{
                                          ...
                                          != (uint32)MCU_BITVAL_0)
  {
    ...
    MCU_SFR_RUNTIME_MODIFY32(SCU_PMCSR0.U,~(((uint32)~(MCU_STANDBY+1U) &\
