...
/** \brief  Length for Ifx_MTU_MEMMAP_Bits.CPU1DxMAP */
#define IFX_MTU_MEMMAP_CPU1DXMAP_LEN (2u)

/** \brief  Mask for Ifx_MTU_MEMMAP_Bits.CPU1DxMAP */
#define IFX_MTU_MEMMAP_CPU1DXMAP_MSK (0x3u)

/** \brief  Offset for Ifx_MTU_MEMMAP_Bits.CPU1DxMAP */
#define IFX_MTU_MEMMAP_CPU1DXMAP_OFF (7u)

/** \brief  Length for Ifx_MTU_MEMMAP_Bits.CPU1PxMAP */
#define IFX_MTU_MEMMAP_CPU1PXMAP_LEN (2u)

/** \brief  Mask for Ifx_MTU_MEMMAP_Bits.CPU1PxMAP */
#define IFX_MTU_MEMMAP_CPU1PXMAP_MSK (0x3u)

/** \brief  Offset for Ifx_MTU_MEMMAP_Bits.CPU1PxMAP */
#define IFX_MTU_MEMMAP_CPU1PXMAP_OFF (10u)
...
/** \brief  Length for Ifx_MTU_MEMTEST0_Bits.CPU1XEN */
#define IFX_MTU_MEMTEST0_CPU1XEN_LEN (6u)

/** \brief  Mask for Ifx_MTU_MEMTEST0_Bits.CPU1XEN */
#define IFX_MTU_MEMTEST0_CPU1XEN_MSK (0x3fu)

/** \brief  Offset for Ifx_MTU_MEMTEST0_Bits.CPU1XEN */
#define IFX_MTU_MEMTEST0_CPU1XEN_OFF (6u)
...
#define IFX_MTU_MEMTEST0_RES_OFF (15u)
...
#define IFX_MTU_MEMTEST1_EMEMLXEN_LEN (12u)

/** \brief  Mask for Ifx_MTU_MEMTEST1_Bits.EMEMLXEN */
#define IFX_MTU_MEMTEST1_EMEMLXEN_MSK (0xfffu)

/** \brief  Offset for Ifx_MTU_MEMTEST1_Bits.EMEMLXEN */
#define IFX_MTU_MEMTEST1_EMEMLXEN_OFF (18u)
...
/** \brief  Length for Ifx_MTU_MEMTEST2_Bits.CIFxEN */
#define IFX_MTU_MEMTEST2_CIFXEN_LEN (2u)

/** \brief  Mask for Ifx_MTU_MEMTEST2_Bits.CIFxEN */
#define IFX_MTU_MEMTEST2_CIFXEN_MSK (0x3u)

/** \brief  Offset for Ifx_MTU_MEMTEST2_Bits.CIFxEN */
#define IFX_MTU_MEMTEST2_CIFXEN_OFF (16u)
