...
#define IFX_XBAR_PRIOL_MASTER0_LEN (4u)

/** \brief  Mask for Ifx_XBAR_PRIOL_Bits.MASTER0 */
#define IFX_XBAR_PRIOL_MASTER0_MSK (0xfu)
...
#define IFX_XBAR_PRIOL_MASTER5_LEN (4u)

/** \brief  Mask for Ifx_XBAR_PRIOL_Bits.MASTER5 */
#define IFX_XBAR_PRIOL_MASTER5_MSK (0xfu)
...
#define IFX_XBAR_PRIOL_MASTER6_LEN (4u)

/** \brief  Mask for Ifx_XBAR_PRIOL_Bits.MASTER6 */
#define IFX_XBAR_PRIOL_MASTER6_MSK (0xfu)

/** \brief  Offset for Ifx_XBAR_PRIOL_Bits.MASTER6 */
#define IFX_XBAR_PRIOL_MASTER6_OFF (24u)

/** \brief  Length for Ifx_XBAR_PRIOL_Bits.MASTER7 */
#define IFX_XBAR_PRIOL_MASTER7_LEN (4u)

/** \brief  Mask for Ifx_XBAR_PRIOL_Bits.MASTER7 */
#define IFX_XBAR_PRIOL_MASTER7_MSK (0xfu)

/** \brief  Offset for Ifx_XBAR_PRIOL_Bits.MASTER7 */
#define IFX_XBAR_PRIOL_MASTER7_OFF (28u)
/** \}  */
/******************************************************************************/
/******************************************************************************/
#endif /* IFXXBAR_BF_H */
