...
#define IFX_FLASH_FSR_RES4_LEN (1u)

/** \brief  Mask for Ifx_FLASH_FSR_Bits.RES4 */
#define IFX_FLASH_FSR_RES4_MSK (0x1u)

/** \brief  Offset for Ifx_FLASH_FSR_Bits.RES4 */
#define IFX_FLASH_FSR_RES4_OFF (4u)
...
#define IFX_FLASH_MARP_RES1_LEN (1u)

/** \brief  Mask for Ifx_FLASH_MARP_Bits.RES1 */
#define IFX_FLASH_MARP_RES1_MSK (0x1u)

/** \brief  Offset for Ifx_FLASH_MARP_Bits.RES1 */
#define IFX_FLASH_MARP_RES1_OFF (1u)
...
#define IFX_FLASH_PROCOND_RES8_LEN (1u)

/** \brief  Mask for Ifx_FLASH_PROCOND_Bits.RES8 */
#define IFX_FLASH_PROCOND_RES8_MSK (0x1u)

/** \brief  Offset for Ifx_FLASH_PROCOND_Bits.RES8 */
#define IFX_FLASH_PROCOND_RES8_OFF (8u)

/** \brief  Length for Ifx_FLASH_PROCOND_Bits.RES9 */
#define IFX_FLASH_PROCOND_RES9_LEN (1u)

/** \brief  Mask for Ifx_FLASH_PROCOND_Bits.RES9 */
#define IFX_FLASH_PROCOND_RES9_MSK (0x1u)

/** \brief  Offset for Ifx_FLASH_PROCOND_Bits.RES9 */
#define IFX_FLASH_PROCOND_RES9_OFF (9u)
...
#define IFX_FLASH_PROCONHSMCOTP_BOOTSEL_LEN (2u)

/** \brief  Mask for Ifx_FLASH_PROCONHSMCOTP_Bits.BOOTSEL */
#define IFX_FLASH_PROCONHSMCOTP_BOOTSEL_MSK (0x3u)

/** \brief  Offset for Ifx_FLASH_PROCONHSMCOTP_Bits.BOOTSEL */
#define IFX_FLASH_PROCONHSMCOTP_BOOTSEL_OFF (14u)
