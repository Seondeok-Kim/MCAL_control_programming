...
typedef union
{
    unsigned int U;                         /**< \brief Unsigned access */
    signed int I;                           /**< \brief Signed access */
    Ifx_SCU_PMSWCR3_Bits B;                 /**< \brief Bitfield access */
} Ifx_SCU_PMSWCR3;
...
typedef union
{
    unsigned int U;                         /**< \brief Unsigned access */
    signed int I;                           /**< \brief Signed access */
    Ifx_SCU_PMSWUTCNT_Bits B;               /**< \brief Bitfield access */
} Ifx_SCU_PMSWUTCNT;
...
typedef volatile struct _Ifx_SCU
{
    ...
    unsigned char reserved_84[24];          /**< \brief 84, \internal Reserved */
    ...
    unsigned char reserved_10C[24];         /**< \brief 10C, \internal Reserved */
