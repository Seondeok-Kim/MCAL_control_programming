...
typedef struct _Ifx_SBCU_DBGNTT_Bits
{
    ...
    unsigned int reserved_1:4;              /**< \brief \internal Reserved */
...
{
    unsigned int DMAH:1;                    /**< \brief [0:0] Cerberus Grant Trigger Enable, High Priority (rw) */
    unsigned int reserved_1:4;              /**< \brief \internal Reserved */
...
{
    unsigned int RESERVED8:4;               /**< \brief [3:0] Reserved (r) */
    unsigned int RESERVED9:4;               /**< \brief [7:4] Reserved (r) */
    unsigned int RESERVEDA:4;               /**< \brief [11:8] Reserved (r) */
    unsigned int RESERVEDB:4;               /**< \brief [15:12] Reserved (r) */
    unsigned int HSMRMI:4;                  /**< \brief [19:16] Master 12 Priority (rw) */
    unsigned int HSMCMI:4;                  /**< \brief [23:20] Master 13 Priority (rw) */
    unsigned int RESERVEDE:4;               /**< \brief [27:24] Reserved (r) */
...
typedef struct _Ifx_SBCU_PRIOL_Bits
{
    ...
    unsigned int RESERVED1:4;               /**< \brief [7:4] Reserved (r) */
    unsigned int RESERVED2:4;               /**< \brief [11:8] Reserved (r) */
    unsigned int RESERVED3:4;               /**< \brief [15:12] Reserved (r) */
    unsigned int RESERVED4:4;               /**< \brief [19:16] Reserved (r) */
    unsigned int DMAM:4;                    /**< \brief [23:20] Master 5 Priority (rw) */
    unsigned int RESERVED6:4;               /**< \brief [27:24] Reserved (r) */
